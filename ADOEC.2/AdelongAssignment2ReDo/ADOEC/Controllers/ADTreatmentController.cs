...
namespace ADOEC.Controllers
{
    public class ADTreatmentController : Controller
    {
        ...
        // GET: ADTreatment
        public async Task<IActionResult> Index(string plotId, string farmName, string name)//name = name of crop
        {
        ...
        public IActionResult Create(string farmName, int? plotId)
        {
            ViewBag.FarmName = farmName;
            ViewBag.PlotId = plotId;
